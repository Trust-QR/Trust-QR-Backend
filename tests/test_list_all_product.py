...
def test_all_product(get_product_contract,dummyData):
    ...
    for k in dummyData:
        ...
        for e in dummyData[k]:
                ...
                temp.append( [e['product_id'],e['product_name'], e['product_description'], e['product_category'],
                            e['country_of_origin'], e['date_of_expiry'], e['date_of_manufacturing'], e['price']/100,tuple(e['urls'])])
